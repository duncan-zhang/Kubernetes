...
echo "\033[34m[TASK 2] Install some tools\033[0m"
...
echo "\033[34m[TASK 4] Add Kernel settings\033[0m"
...
echo "\033[34m[TASK 5] Install containerd runtime\033[0m"
...
echo "\033[34m[TASK 6] Add apt repo for kubernetes\033[0m"
...
echo "\033[34m[TASK 7] Install kubernetes tools\033[0m"
apt-get update >/dev/null 2>&1
apt-get install -y kubelet kubeadm kubectl >/dev/null 2>&1
apt-mark hold kubelet kubeadm kubectl >/dev/null 2>&1

echo "\033[34m[TASK 8] Remove shell script files\033[0m"
rm -f install-k8s.sh

echo "\033[34m===============Automatic installation completed===============\033[0m"
